...
int main()
{
	...
	/*
	 * 3. Triangle mesh setting and set init position here
	 */
    ...
    int current_frame = 0;
    while(current_frame <= max_render_time) {
        // todo: update mesh position here
        ...
        */
        ...
        outputPath += std::to_string(current_frame) + ".png";
